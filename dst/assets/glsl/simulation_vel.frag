...
vec3 snoiseVec3( vec3 x ){
  ...
  float s  = snoise4D(vec4( vec3(x) , timer * 0.1));
  float s1 = snoise4D(vec4( x.y - 19.1 , x.z + 33.4 , x.x + 47.2 , timer * 0.01 ));
  float s2 = snoise4D(vec4( x.z + 74.2 , x.x - 124.5 , x.y + 99.4 , timer * 0.2 ));
  vec3 c = vec3( s , s1 , s2 );
  return c;
